...
function New-DatabaseRecord {
    ...
    Write-Host "Se Insertan los datos"
    $Data | Format-Table
}

function Set-DatabaseRecord {
    param(
        [String]
        $Hostname = "localhost\SQLEXPRESS",
        [Parameter(Mandatory = $true)]
    ...
    Write-Host "Se Actualizan los datos"
    $Data | Format-Table
}
...
function Remove-DatabaseRecord {
    ...
    Write-Host "Se Eliminan los datos con el filtro:"
    $Data | Format-Table
}
...
Export-ModuleMember -Function New-DatabaseRecord
Export-ModuleMember -Function Set-DatabaseRecord
Export-ModuleMember -Function Remove-DatabaseRecord
Export-ModuleMember -Function Select-Table
